...
attention of mathematicians, in @parker_balanced_1955, the
...
first general result, that of @hwang_more_1970, coming only a
few years before the corresponding problem for Room squares
was settled @wallis_existence_1973.
...
cells $(k, j'_m), (n, j'_m)$, respectively.  For example,
...
has noticed a flaw in this approach
...
\begin{enumerate}
  \item{$P$ and $Q$ are a \emph{Latin pair} such that,}
...
\begin{equation}
(x^{4i}, -x{4i + 1}), (x^{4i + 2}, x^{4i + 1}) \quad 0 \leq i \leq 2k
\end{equation}
